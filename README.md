...
- 提供 `references/gpt-image-2.md` 作为尺寸、比例、输出参数和官方链接速查。
...
`gpt-image-2` 支持 1K、2K、4K 级别尺寸。常见比例建议优先使用：
...
自定义尺寸需要满足：最大边不超过 `3840px`、宽高都是 `16` 的倍数、长短边比例不超过 `3:1`、总像素不超过 `8,294,400`。

更多尺寸、质量和输出格式规则见 [GPT Image 2 参考速查](references/gpt-image-2.md)。
